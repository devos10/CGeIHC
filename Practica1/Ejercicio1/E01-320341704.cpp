...
int main()
{
	...
	//CREAR VENTANA
	GLFWwindow *mainWindow = glfwCreateWindow(WIDTH, HEIGHT, "Primer ventana - Ejercicio1", NULL, NULL);
 ...
 //Llamada a las funciones creadas antes del main
	...
	int color = 0; // inicializamos la variable 
	//y usamos el siguiente código de colores 0 = rojo, 1 = verde, 2 = azul
	...
	while (!glfwWindowShouldClose(mainWindow))
	{
		...
		if (actual - ultimo >= 1.0) // cambia cada 1 segundo
		{
			color = (color+ 1) % 3; // rota entre 0,1,2
			ultimo = actual;
		}
		...
		if (color == 0)
			...
			glClearColor(0.0f, 0.6f, 0.0f, 1.0f); // verde
		else
