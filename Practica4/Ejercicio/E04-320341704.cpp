...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//CUARTA ARTICULACION
		model = modelaux;                                                                // regresar al centro del 3er brazo
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		...
		/*
		// SOPORTE
		glm::mat4 soporte = model;
		soporte = glm::translate(soporte, glm::vec3(0.8f, 0.0f, 0.0f));
		glm::mat4 soporteScaled = soporte;
		soporteScaled = glm::scale(soporteScaled, glm::vec3(1.6f, 0.6f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(soporteScaled));
		color = glm::vec3(0.8f, 0.8f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();*/

		// CANASTA 
		model = glm::rotate(model, glm::radians(135.0f), glm::vec3(0.0f, 0.0f, 1.0f)); // ← cancela el -135° de 
